...
$sdl2Url = "https://www.libsdl.org/release/SDL2-devel-2.0.x-VC.zip"
$sdl2TtfUrl = "https://www.libsdl.org/projects/SDL_ttf/release/SDL2_ttf-devel-2.0.x-VC.zip"
$sdl2ImageUrl = "https://www.libsdl.org/projects/SDL_image/release/SDL2_image-devel-2.0.x-VC.zip"
$raylibUrl = "https://github.com/raysan5/raylib/releases/download/3.7.0/raylib-3.7.0_win64_msvc15_lib.zip"
